...
export const planInfos = [
  ...
  },
  {
    ...
    info: ["✔ Tudo do Plano A", "✔ Acesso a aulas ao vivo", "✔ Acesso a +100 Aulas gravadas", "oi4"]
  },
  {
...
export const privacyData = [
      ...
      {
          subtitle: 'SEÇÃO 2 - COMO RECOLHEMOS OS DADOS PESSOAIS DO USUÁRIO E DO VISITANTE?',
          paragraphs: [
              {
      ...
      {
          subtitle: 'SEÇÃO 3 - QUAIS DADOS PESSOAIS RECOLHEMOS SOBRE O USUÁRIO E VISITANTE?',
          paragraphs: [
              {
      ...
      {
          subtitle: 'SEÇÃO 3 - PARA QUE FINALIDADES UTILIZAMOS OS DADOS PESSOAIS DO USUÁRIO E VISITANTE?',
          paragraphs: [
              {
      ...
      {
          subtitle: 'SEÇÃO 7- OS DADOS PESSOAIS ARMAZENADOS SERÃO TRANSFERIDOS A TERCEIROS?',
          paragraphs: [
              {
